...
## Quando usar
É a última atividade da cadeia. Prepara o material assim que Comunicação com Stakeholders termina, mas só libera de fato depois que a aprovação humana do portão do Orquestrador acontece. Preparar e liberar são passos separados.
...
4. Espere a confirmação do portão de aprovação humana do [[agents/orquestrador/AGENT]]. Sem essa confirmação, o material fica pronto mas não é liberado como "entregue".
